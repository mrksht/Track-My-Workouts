  ...
  return (
    <div className="space-y-4 pb-4">
      ...
      <button
        onClick={saveWorkout}
        disabled={saving}
        className="w-full py-3 bg-accent-green hover:bg-accent-green/90 text-white font-semibold rounded-xl flex items-center justify-center gap-2 transition-colors disabled:opacity-50"
      >
        {saving ? (
